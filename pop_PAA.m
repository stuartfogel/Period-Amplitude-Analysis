...
uilist = { ...
    ...
    {'style', 'text', 'string', 'Label for all sleep stages (comma-separated)'} ...
    {'style', 'edit', 'string', 'W, N1, N2, SWS, REM, Unscored' 'tag' 'allSleepStages'} ...
    {'style', 'text', 'string', 'Label for sleep stages to exclude SW (comma-separated)'} ...
    {'style', 'edit', 'string', 'W, N1, REM, Unscored' 'tag' 'badSleepstages'} ...
    {'style', 'text', 'string', 'Label for bad data (comma-separated)'} ...
    {'style', 'edit', 'string', 'Movement, Arousal' 'tag' 'badData'} ...
...
com = sprintf('EEG = PAA(''%s'',''%s'',''%s'',''%s'',''%s'',''%s'');',inputname(1),ChOI,result{3},result{1},result{2},result{4});
